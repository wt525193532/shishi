  ...
  >
    <div class="gl-content-item">
      ...
      >
        ...
        <el-form-item class="gl-form-item" label="发文单位">
          <el-input
            v-model="receiveForm.sendWorkspalce"
            placeholder=""
          ></el-input>
        </el-form-item>
        ...
        <el-form-item class="gl-form-item file-send" label="主题">
          <el-input v-model="receiveForm.theme" placeholder=""></el-input>
        </el-form-item>
        <el-form-item class="gl-form-item file-send" label="文档类型">
          <el-select
