<template>
  <div class="basicinfo-selector">
    <el-form-item label="矿山名称" :class="isAdd ? 'form-item-btn' : ''">
      <el-input
        disabled
        placeholder="请查找矿山名称"
        :value="value.name"
    ...
    <el-form-item label="区县">
      <el-select disabled :value="value.admin.country" placeholder="请选择">
      </el-select>
    </el-form-item>

    <el-form-item label="乡镇">
      <el-select disabled :value="value.admin.town" placeholder="请选择">
      </el-select>
    </el-form-item>
    ...
    >
      <el-form label-width="85px" size="small">
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="矿山编号">
              <el-input :value="queryParameter.disasterCode"> </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="矿山名称">
              <el-input :value="queryParameter.disasterName"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
