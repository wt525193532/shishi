<template>
  <div class="page-container">
    <div class="clearfix" v-if="!canEdit && !isFromQuery">
      <el-button
    ...
    <div
      ...
      class="basicinfo-form form-wrapper"
      id="basicInfoPrint"
    >
...
export default {
  ...
  created() {
    ...
    if (this.formType == "create") {
      ...
      api = "report/basicInfo/edit";
      this.canEdit = true;
      this.isDisabled = false;
    } else {
      api = "querypage/basicInfo/getById";
      this.canEdit = false;
      this.isDisabled = false;
    }
    if (this.formType != "create") {
      this.$store.dispatch(api, this.$route.query.id).then(res => {
        if (this.formType == "edit" && res.data.result.admin.countryCode) {
          this.$store
            .dispatch(
