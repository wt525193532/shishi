<template>
  <div class="page-container">
    ...
    <div class="form-wrapper" id="relocationPrint">
        ...
        >
          ...
          <div class="form-item">
            ...
            <div class="form-item-wapper">
              ...
              >
                <el-select
                  v-model="formData.placeTypeCode"
                  placeholder="请选择"
                >
                  <el-option
              ...
              >
                <el-select
                  v-model="formData.isDangerInNew"
                  placeholder="请选择"
                >
          ...
          <div class="form-item">
            ...
            <div class="form-item-wapper">
              <el-form-item label="是否已验收">
                <el-select
                  v-model="formData.isAcceptanced"
                  placeholder="请选择"
                >
                  <el-option label="是" :value="true"></el-option>
                  <el-option label="否" :value="false"></el-option>
...
export default {
  ...
  data() {
    return {
      ...
      formData: {
        ...
        isAccepted: true,
        acceptanceReasons: "",
        isPublishedDetail: true,
        houseDismantleTime: null,
        relocationPersons: 0,
        locationName: "",
        transLocationName: "",
        transitionInTime: null,
        remark: "",
        familyMembers: 0,
        houseHolderPhone: "",
        planBuildLocation: "",
        oldHouseArea: 0,
        isPublishedApply: true,
        groupSuggestion: "",
        vallageSuggestion: "",
        townSuggestion: "",
        landBureauSuggestion: "",
        isCityMonitor: true,
        isCountryMonitor: true,
        applyTime: null,
        isAcceptanced: true,
        newHouseAddress: "",
        newHouseArea: 0,
  ...
  created() {
    ...
    if (this.formType == "create") {
      ...
      api = "report/relocation/edit";
      this.disabled = false;
      this.canEdit = false;
    } else {
      api = "querypage/relocation/getById";
      this.disabled = true;
      this.canEdit = false;
    }
            ...
            if (this.formData.site.code) {
              ...
              if (this.formType == "create") {
                ...
                flag = await this.$store
                  .dispatch("report/relocation/create", this.formData)
                  .then(async res => {
                ...
                this.$store
                  .dispatch("report/relocation/update", this.formData)
                  .then(res => {
